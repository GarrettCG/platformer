...
import unofficialsdk.glutil.Shader;
...
public class Framework {
	...
	public static String findFileOrThrow(String filename) {
		...
		throw new RuntimeException("Could not find the file " + filename+" the current tutorial datapath is "+CURRENT_TUTORIAL_DATAPATH+" current common datapath is "+COMMON_DATAPATH);
	}
